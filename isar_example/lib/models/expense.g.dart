...
const ExpenseSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'payment': PropertySchema(
      ...
      name: r'payment',
      type: IsarType.byte,
      enumMap: _ExpensepaymentEnumValueMap,
    ),
...
void _expenseSerialize(
  ...
  writer.writeByte(offsets[2], object.payment.index);
...
Expense _expenseDeserialize(
  ...
  object.id = id;
  object.payment =
      _ExpensepaymentValueEnumMap[reader.readByteOrNull(offsets[2])] ??
          Payment.card;
...
P _expenseDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_ExpensepaymentValueEnumMap[reader.readByteOrNull(offset)] ??
          Payment.card) as P;
    case 3:
...
const _ExpensepaymentEnumValueMap = {
  'card': 0,
  'cash': 1,
};
const _ExpensepaymentValueEnumMap = {
  0: Payment.card,
  1: Payment.cash,
};
...
extension ExpenseQueryFilter
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> paymentEqualTo(
      Payment value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'payment',
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> paymentGreaterThan(
    Payment value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> paymentLessThan(
    Payment value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> paymentBetween(
    Payment lower,
    Payment upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExpenseQuerySortBy on QueryBuilder<Expense, Expense, QSortBy> {
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> sortByPayment() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'payment', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortByPaymentDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQuerySortThenBy
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenByPayment() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'payment', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenByPaymentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'payment', Sort.desc);
    });
  }
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByPayment() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, Payment, QQueryOperations> paymentProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'payment');
    });
  }

  QueryBuilder<Expense, double, QQueryOperations> quantityProperty() {
    return QueryBuilder.apply(this, (query) {
